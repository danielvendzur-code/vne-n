(() => {
  ...
  const WIDGET_RELEASE = "interaction-loader-20260912-v1";
  const ONE_STROKE =
  ...
  const removeLauncher = () => document.getElementById(LAUNCHER_ID)?.remove();
  ...
  function showLauncher(failed = false) {
    ...
    anchor.innerHTML = `
      <svg width="50" height="50" viewBox="0 0 112 112" fill="none" focusable="false" aria-hidden="true">
        <path d="${ONE_STROKE}" stroke="currentColor" stroke-width="7.75"
