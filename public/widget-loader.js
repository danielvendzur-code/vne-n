    ...
    anchor.innerHTML = `
      <span aria-hidden="true">
        <svg width="42" height="42" viewBox="0 0 112 112" fill="none" focusable="false">
          <path d="M8.5 12.4C8.5 7.2 14.5 4.5 18.3 6.4L52.5 34.5C54.1 36.1 57.9 36.1 59.5 34.5L95.4 6.4C99.2 4.5 103.6 7.2 103.6 12.4V79.9C103.6 82.6 101.4 84.8 98.7 84.8H52.9L30.5 105.5L30.2 84.8H13.4C10.7 84.8 8.5 82.6 8.5 79.9Z"
                stroke="currentColor" stroke-width="7.2" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M24 71.2V29.2L52.5 55.4C54.1 57 57.9 57 59.5 55.4L88 29.2V71.2"
                stroke="currentColor" stroke-width="7.2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </span>
