              ...
              {active && (
                <motion.span
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 8px 24px rgba(0, 0, 0, 0.22), 0 1px 0 rgba(156, 145, 133, 0.04) inset",
                  }}
    ...
    <div>
      <div className="flex items-baseline justify-between mb-2">
        <label
          ...
          style={{
            color: dark ? "color-mix(in oklab, #9c9185 65%, transparent)" : "var(--text-secondary)",
          }}
        >
          {label}
        </label>
        <span
          ...
          style={{ color: dark ? "#9c9185" : "var(--text-primary)" }}
        >
          {value}
          {unit ? ` ${unit}` : ""}
        </span>
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-2">
      <span
        ...
        style={{
          color: dark ? "color-mix(in oklab, #9c9185 55%, transparent)" : "var(--text-secondary)",
        }}
      >
        {label}
      </span>
