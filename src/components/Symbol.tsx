  ...
  return (
    ...
    >
      <path
        ...
        d="M20 8V5.7"
        stroke="var(--brand-symbol-signal, #ff9276)"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
      <circle
        ...
        cy="4"
        r="2.25"
        fill="var(--brand-symbol-signal, #ff9276)"
      />
      <path
        ...
        fill="var(--brand-symbol-shell, #f4fbf8)"
      />
      <rect
        ...
        height="16.5"
        rx="8.25"
        fill="var(--brand-symbol-face, #32d3a2)"
      />
      <path
        className="brand-symbol__highlight"
        d="M13 14.15c1.55-1.15 3.4-1.7 5.65-1.7h4.6"
        stroke="rgba(244,251,248,.48)"
        strokeWidth="1.15"
        strokeLinecap="round"
      />
      <g className="brand-symbol__eyes" fill="#071b1c">
        <ellipse cx="15.7" cy="18.7" rx="1.7" ry="1.95" />
        <ellipse cx="24.3" cy="18.7" rx="1.7" ry="1.95" />
      </g>
      <circle cx="16.3" cy="18" r="0.48" fill="#f4fbf8" fillOpacity="0.92" />
      <circle cx="24.9" cy="18" r="0.48" fill="#f4fbf8" fillOpacity="0.92" />
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="9.45" cy="19.1" r="1.22" fill="var(--brand-symbol-signal, #ff9276)" />
      <circle cx="30.55" cy="19.1" r="1.22" fill="var(--brand-symbol-signal, #ff9276)" />
      <path
        className="brand-symbol__accent"
        d="m32.55 8.25.55 1.35 1.35.55-1.35.55-.55 1.35L32 10.7l-1.35-.55L32 9.6l.55-1.35Z"
        fill="var(--brand-symbol-accent, #70a8ff)"
      />
    </svg>
  );
}
