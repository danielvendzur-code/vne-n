    ...
    stages: [
      {
        ...
        result: "„Potrebujem poradiť s výberom.“",
      },
      {
        index: "02",
        label: "DOPLNENIE",
        title: "Chatbot si vypýta len to podstatné.",
        copy: "Pýta sa iba na údaje, ktoré menia odpoveď alebo ďalší krok.",
        result: "Typ služby · miesto · termín",
      },
      {
        index: "03",
        label: "ODPOVEĎ",
        title: "Dostane jasnú odpoveď.",
        copy: "Podľa vašej ponuky vysvetlí možnosti a odporučí ďalší krok.",
        result: "Odpoveď · možnosti · ďalší krok",
      },
      {
        index: "04",
        label: "DOPYT",
        ...
        result: "Kontakt + zhrnutie požiadavky",
      },
    ],
  },
  calculator: {
    ...
    stages: [
      {
        ...
        copy: "Výpočet začne priamo na webe bez telefonátu.",
        result: "„Koľko to bude približne stáť?“",
      },
      {
        index: "02",
        label: "ÚDAJE",
        title: "Vyberie, čo cenu mení.",
        copy: "Napríklad rozmer, množstvo, model, montáž alebo doplnky.",
        result: "Rozmer · množstvo · variant",
      },
      {
        index: "03",
        label: "VÝPOČET",
        ...
        result: "Vaše pravidlá + váš cenník",
      },
      {
        index: "04",
        label: "VÝSLEDOK",
    ...
    stages: [
      {
        ...
        result: "Čo potrebujem?",
      },
      {
        index: "02",
        label: "MOŽNOSTI",
        title: "Vidí len dostupné možnosti.",
        copy: "Rozmery, modely, farby a doplnky ukážeme v správnom poradí.",
        result: "Model · rozmer · farba · doplnky",
      },
      {
        index: "03",
        label: "KONTROLA",
...
function ChapterRail() {
  ...
  return (
    <nav
      ...
      aria-label="Navigácia po stránke"
    >
  ...
  return (
    <section className="competition-hero" id="uvod" aria-labelledby="competition-hero-title">
      ...
      <div className="container-page competition-hero__foot">
        ...
        <a href="#riesenia">
          Vybrať riešenie <ArrowRight size={16} />
        </a>
      </div>
    </section>
  );
      ...
      >
        ...
        {id === "advisor" ? (
          <div className="preview-advisor">
            ...
            <div className="preview-advisor__chips">
              <i>do 100 €</i>
              <i>pre začiatočníka</i>
            </div>
            <div className="preview-advisor__result">
              <b>Produkt 03</b>
              <p>Spĺňa vaše priority a rozpočet.</p>
            </div>
          </div>
        ) : null}
      </motion.div>
...
function Solutions() {
  ...
  return (
    <section
      className="competition-solutions"
      id="riesenia"
      aria-labelledby="competition-solutions-title"
    >
      ...
      <div className="container-page competition-solutions__body">
        <div className="competition-solutions__list">
          {solutions.map((solution) => (
            <button
              ...
              onClick={() =>
                openSiteAssistant({ source: `competition-${solution.id}`, preset: solution.preset })
              }
            >
        ...
        <div className="competition-solution-preview" aria-live="polite">
          <div className="competition-solution-preview__top">
            <span>ŽIVÁ UKÁŽKA</span>
            <b>{selected.name}</b>
          </div>
          ...
          <button
            type="button"
            onClick={() =>
              openSiteAssistant({ source: "competition-preview", preset: selected.preset })
            }
          >
        ...
        {realizations.map((project, index) => (
          <article key={project.name}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="competition-work__visual"
            >
    ...
    <section className="competition-benefit" aria-labelledby="competition-benefit-title">
      <div className="container-page competition-benefit__inner">
        ...
        <div>
          <p>
            <b>01</b>
            <strong>Dostane odpoveď</strong>
            <span>Bez hľadania po celom webe.</span>
          </p>
          <p>
            <b>02</b>
            <strong>Urobí výber</strong>
            <span>Bez zbytočných možností.</span>
          </p>
          <p>
            <b>03</b>
            <strong>Pošle lepší dopyt</strong>
            <span>Vy už poznáte základný kontext.</span>
          </p>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="competition-demos" id="ukazky" aria-labelledby="competition-demos-title">
      ...
      <div className="container-page competition-demos__grid">
        {webko ? (
          <a href={webko.href} target="_blank" rel="noreferrer" className="competition-demo">
            <div>
              <img src={webko.image} alt={webko.alt} loading="lazy" />
              <span>WEBKO</span>
              <b>
                Otvoriť web <ArrowUpRight size={16} />
              </b>
            ...
            <h3>WEBKO</h3>
            <p>Celý prezentačný web na živej doméne.</p>
          </a>
        ) : null}
        {aplan ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="competition-demo competition-demo--aplan"
          >
            <div className="competition-aplan">
              <span>
                APLAN AI <i>ONLINE</i>
              </span>
            ...
            <h3>APLAN AI</h3>
            <p>Interaktívny asistent, ktorý môžete prejsť celý.</p>
          </a>
        ) : null}
        <button
          type="button"
          className="competition-demo competition-demo--chat"
          onClick={() => openSiteAssistant({ source: "competition-live-demo", preset: "inquiry" })}
        >
          <div className="competition-chat-demo">
            <BrandMark size={44} />
            <MessageSquareText size={24} />
            <p>Napíšte otázku alebo si vyskladajte riešenie.</p>
            <b>
              Otvoriť Môj Chatbot <ArrowUpRight size={16} />
            </b>
          </div>
          <h3>Môj Chatbot</h3>
          <p>Presne ten widget, ktorý môže bežať aj na vašom webe.</p>
        </button>
      </div>
    </section>
  );
  ...
  return (
    <section className="competition-audience" id="pre-eshopy" aria-label="Pre koho je riešenie">
      <article>
        ...
        <p>Chatbot a kalkulačka vybavia prvé otázky a pripravia dopyt.</p>
        <button
          type="button"
          onClick={() => openSiteAssistant({ source: "competition-services", preset: "inquiry" })}
        >
      ...
      <article>
        ...
        <button
          type="button"
          onClick={() => openSiteAssistant({ source: "competition-commerce", preset: "product" })}
        >
          Ukázať riešenie <ArrowRight size={16} />
        </button>
      </article>
...
function ProcessAndPrice() {
  const steps = [
    ...
    [
      ...
      "Dizajn, logiku aj napojenia skontrolujeme na počítači aj mobile.",
    ],
    ...
    <>
      <section className="competition-process" aria-labelledby="competition-process-title">
        <div className="container-page competition-section-head">
          ...
          <h2 id="competition-process-title">Od prvého rozhovoru po nasadenie.</h2>
          <Link to="/postup">
      ...
      <section className="competition-price" id="cena" aria-labelledby="competition-price-title">
        <div className="container-page competition-section-head">
          <span>CENA</span>
          <h2 id="competition-price-title">Koľko to stojí?</h2>
          <p>Presnú cenu poviem po krátkom prejdení vášho webu a zadania.</p>
        </div>
        <div className="container-page competition-price__grid">
          ...
          <Link to="/cennik">
            Pozrieť cenník <ArrowUpRight size={17} />
          </Link>
        </div>
      </section>
    </>
...
function FinalCta() {
  return (
    <section className="competition-final" aria-labelledby="competition-final-title">
      <div className="container-page competition-final__brand">
        <BrandMark size={52} />
        <span>MÔJ CHATBOT</span>
      </div>
      <div className="container-page competition-final__body">
        <span>ĎALŠÍ KROK</span>
        <h2 id="competition-final-title">Chcete to aj na svoj web?</h2>
        <p>Pošlite mi web. Navrhnem, čo by na ňom malo zmysel a koľko by to stálo.</p>
        <div>
          <Link to="/kontakt">
