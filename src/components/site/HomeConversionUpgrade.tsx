...
const packages: Array<{
...
}> = [
  {
    ...
    monthly: "29 € / mes.",
    badge: null,
    copy: "Pre jednoduchý AI chatbot na firemný web.",
    features: [
      "Chatbot podľa obsahu vašej firmy",
      "Odpovede na časté otázky zákazníkov",
      "Základné zbieranie dopytu a kontaktu",
      "Vloženie na existujúci web",
      "Nastavenie dizajnu podľa vášho webu",
      "Responzívna verzia pre mobil aj počítač",
    ],
    preset: "inquiry",
  },
  {
    ...
    copy: "Pre firmy, kde chatbot nemá len odpovedať, ale reálne pomáhať predávať.",
    features: [
      "Všetko zo START",
      "Vlastná konverzačná logika a kvalifikácia zákazníka",
      "Chatbot s kalkulačkou alebo jednoduchým konfigurátorom",
      "Pripravený dopyt na e-mail",
      "Viac vlastných scenárov podľa vašej ponuky",
      "Pokročilejšie prispôsobenie dizajnu",
      "Meranie základných konverzií",
    ],
    preset: "calculator",
  },
  {
    ...
    monthly: "59 € / mes.",
    badge: null,
    copy: "Pre pokročilé riešenia s vlastnou logikou a napojením na vaše systémy.",
    features: [
      "Všetko zo SMART",
      "Kalkulačka či konfigurátor s vlastnou logikou",
      "Komplexnejšie vetvenie a viac typov dopytov",
      "Voliteľné prepojenie podľa projektu — kalendár, Google Sheets, CRM či API",
      "Pokročilé automatizácie",
      "Individuálne UX a prioritné úpravy",
    ],
    preset: "product",
  },
];
