...
const errorPanelStyle = {
  border: "1px solid rgba(13,16,37,.12)",
  borderRadius: "1rem",
  padding: "clamp(1.7rem, 5vw, 3rem)",
  background: "#ffffff",
  boxShadow: "0 30px 90px -58px rgba(13,16,37,.35)",
} as const;
  ...
  return (
    ...
    >
      <div className="max-w-lg text-center" style={errorPanelStyle}>
        ...
        <p className="mt-5 text-sm" style={{ color: "#667085", lineHeight: 1.65 }}>
  ...
  return (
    ...
    >
      <div className="max-w-md text-center" style={errorPanelStyle}>
        <p style={{ color: "#5b5ef7", fontSize: ".72rem", fontWeight: 800 }}>MÔJ CHATBOT</p>
        <h1 className="mt-3 text-xl font-semibold" style={{ color: "#0d1025" }}>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex min-h-11 items-center justify-center px-4 py-2 text-sm font-bold"
            style={{
              backgroundColor: "#5b5ef7",
              color: "#ffffff",
              border: "1px solid #5b5ef7",
          ...
          <a
            ...
            className="inline-flex min-h-11 items-center justify-center px-4 py-2 text-sm font-bold"
            style={{
              border: "1px solid rgba(13,16,37,.14)",
              color: "#0d1025",
              background: "#ffffff",
              borderRadius: "0.55rem",
            }}
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#f8f9ff" },
