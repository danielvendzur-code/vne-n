  ...
  "@graph": [
    {
      ...
      address: {
        "@type": "PostalAddress",
        streetAddress: "J. C. Hronského 3427/6",
        postalCode: "949 07",
      ...
      identifier: {
        "@type": "PropertyValue",
        name: "IČO",
        value: siteConfig.legal.ico,
      },
      taxID: siteConfig.legal.dic,
      vatID: siteConfig.legal.icDph,
      description:
        "Prevádzkovateľ služby Môj Chatbot, ktorá vytvára chatboty, kalkulačky, konfigurátory a produktových poradcov na mieru.",
    ...
    },
    {
      ...
      serviceType:
        "Chatboty, cenové kalkulačky, produktové konfigurátory a produktoví poradcovia na mieru",
      provider: { "@id": `${publicOrigin}/#business` },
      areaServed: { "@type": "Country", name: "Slovensko" },
      availableLanguage: ["sk"],
      knowsAbout: [
        "chatbot na mieru",
