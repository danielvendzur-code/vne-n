  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; }
      body { font: 15px/1.5 system-ui, -apple-system, sans-serif; background: radial-gradient(circle at 18% 10%, rgba(201,170,112,.09), transparent 32rem), radial-gradient(circle at 88% 86%, rgba(255, 199, 157,.08), transparent 28rem), #06120e; color: #f2efe6; display: grid; place-items: center; min-height: 100vh; margin: 0; padding: 1.5rem; }
      ...
      .secondary:hover { border-color: rgba(255, 199, 157,.5); }
      :focus-visible { outline: 3px solid #ffc79d; outline-offset: 3px; }
    </style>
  </head>
  <body>
    <div class="card">
