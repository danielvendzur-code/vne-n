...
export const projects: Project[] = [
  {
    ...
    problem: "Zákazník sa opýta na cenu, ale bez rozsahu a doplnkov sa nedá odpovedať.",
    solution:
  ...
  },
  {
    ...
    shortDescription: "Postupné otázky, ktoré z krátkej správy pripravia konkrétny dopyt.",
  ...
  },
  {
    ...
    shortDescription: "Pomoc s výberom podľa spôsobu použitia, preferencií a rozpočtu.",
  ...
  },
  {
    ...
    shortDescription: "Výpočet podľa rozmerov, materiálu, montáže, dopravy a doplnkov.",
    problem: "Ceny závisia od kombinácie viacerých premenných.",
    solution: "Kalkulačka pozná pravidlá firmy a použije správnu sadzbu pre danú kombináciu.",
  ...
  },
  {
    ...
    solution: "Asistent poradí s výberom, doručením a po napojení odpovedá na stav objednávky.",
  ...
  },
  {
    ...
    shortDescription: "Zistí základné údaje a následne otvorí dostupné termíny v kalendári.",
    problem: "Klient chce rovno termín, nie výmenu e-mailov.",
    solution: "Asistent zistí typ služby a otvorí kalendár s reálnymi voľnými termínmi.",
