...
test("the final visual-QA layer removes clipping and legacy warm states", async () => {
  ...
  assert.match(css, /\.lp-project:nth-child\(1\) \.lp-project-copy h3[\s\S]*max-width: none !important/);
  ...
  assert.match(css, /\.lp-tl-steps li\[data-reached="true"\] \.lp-tl-node[\s\S]*background: var\(--sh-lime\) !important/);
